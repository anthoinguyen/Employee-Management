        ...
        try {
            ...
            if (!user)
            {
                ...
                let data = {
                    ...
                    noi_o_hien_nay: user.registeredTempResidence || dot(30),
                    sdt: user.phoneNumber || dot(3),
                    dan_toc: user.nation || dot(3),
                    ton_giao: user.religion || dot(3),
                    nghe_nghiep_truoc_tuyen_dung: user.occupationRecruited || dot(5),
                    ...
                    td_hocvan: user.educationLevel.generalEducation.whichClass || dot(3),
                    hocham_hocvi: user.educationLevel.highestQualification || dot(3),
